...
CulicidaeLab — это комплексная платформа для исследований, надзора и анализа данных о комарах. Она сочетает в себе бэкенд (API на FastAPI) с динамическим фронтендом (Solara) для предоставления инструментов для определения видов, визуализации данных и получения информации, связанной с комарами и переносимыми ими заболеваниями.
