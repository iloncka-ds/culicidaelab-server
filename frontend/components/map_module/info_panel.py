...
# Relative imports
from frontend.state import selected_map_feature_info, selected_species_reactive, observations_data_reactive
from frontend.config import SPECIES_COLORS, COLOR_BUTTON_PRIMARY_BG, FONT_BODY, COLOR_TEXT, FONT_HEADINGS
...
def InformationDisplay():
    ...
    with solara.Column():
        ...
        if feature_info:
            ...
            rv.Divider(style_="margin: 10px 0;")
