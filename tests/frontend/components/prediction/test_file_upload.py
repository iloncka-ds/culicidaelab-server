...
with patch.dict('sys.modules', {
    ...
    # Mock the config module before importing file_upload
    import sys
...
def test_file_upload_component_rendering():
    ...
    # Verify the component renders the upload prompt
...
def test_file_upload_component_loading_state():
    ...
    # Call the component with loading state
    file_upload.FileUploadComponent(
        on_file_selected=MagicMock(),
        upload_error_message=None,
        is_processing=True
