...
from culicidaelab_server.config import (
    DEFAULT_MAP_CENTER,
    DEFAULT_MAP_ZOOM,
    ...
    # Add BREEDING_SITES_ENDPOINT if defined in config
    API_BASE_URL,  # Assuming breeding sites endpoint follows pattern
)

BREEDING_SITES_ENDPOINT = f"{API_BASE_URL}/geo/breeding_sites"  # Define here or in config
